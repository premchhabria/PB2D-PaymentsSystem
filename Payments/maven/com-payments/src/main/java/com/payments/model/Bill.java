...
public class Bill {
	...
	public String toString() {
		return "Bill [bill_id=" + bill_id + ", biller_code=" + biller_code + ", consumer_no=" + consumer_no
				+ ", amount=" + amount + ", due_date=" + due_date + ", status=" + status + ", getBill_id()="
				+ getBill_id() + ", getBiller_code()=" + getBiller_code() + ", getConsumer_no()=" + getConsumer_no()
				+ ", getAmount()=" + getAmount() + ", getDue_date()=" + getDue_date() + ", getStatus()=" + getStatus()
